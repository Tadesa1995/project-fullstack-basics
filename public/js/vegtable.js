...
//     if(categories[i].category== "vegtable") {
//         vegtable.innerHTML +=`<article>
...
//     })
// };
function vegtableCategories(products){
    let root = document.getElementById("vegtable")
    for (let i = 0; i < products.length; i++) {
        if(products[i].category== "vegtable") {
